/**
 * Neelamb Multi-Site Share Plugin
 * Compatible with any domain and website.
 * Features: Auto-URL detection, Inline Count, Black X Logo.
 */

(function() {
    // १. स्टाइल इन्जेक्सन (सबै वेबसाइटका लागि एउटै डिजाइन)
    const injectStyles = () => {
        ...
        style.textContent = `
            ...
            .neelamb-count-inline {
                ...
                padding-right: 15px; border-right: 2px solid #ddd; margin-right: 5px; min-width: 60px;
            }
            ...
            .neelamb-btn-round {
                ...
                font-size: 18px; border: none; cursor: pointer; box-shadow: 0 3px 6px rgba(0,0,0,0.1);
            }
            ...
            .bg-tw { background: #000000; color: #fff !important; }
    ...
    // २. शेयर काउन्ट लजिक (प्रत्येक डोमेनको छुट्टाछुट्टै काउन्ट हुनेछ)
    ...
    const renderNeelamb = () => {
        ...
        const pluginHTML = `
            <div class="neelamb-share-plugin">
                ...
                <a class="neelamb-btn-round bg-tw" title="X (Twitter)" href="https://twitter.com/intent/tweet?url=${encodeURIComponent(url)}&text=${encodeURIComponent(title)}" target="_blank"><i class="fa-brands fa-x-twitter"></i></a>
