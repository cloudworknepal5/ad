/**
 * janawaazkhabar - Universal PWA Manager (v2.1)
...
const PWA_MANAGER = {
    ...
    settings: {
        name: "janawaazkhabar",
        shortName: "janawaazkhabar",
        themeColor: "#2196f3",
        icon: "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh_A2bIFW3RVG-lirfVqMJSedMn2o6wlZMpZg_akRL_880tqN5r1s1wj3qU5lg98cdyMzkQWSg9vz74Kv-XOkKuOIbDpMx7Usi5pdUQPuHkPSUHIB8ICg0YGiJ-338nNPgMGA7Qbg1uXyu2iGlg9UKDsNvmAiESiSD_bG6PmMz2PrwGGQ/s512/logo%20copy.png"
    },
        ...
        const bannerHTML = `
            <div id="pware-banner" style="display:none; position:fixed; bottom:20px; left:15px; right:15px; background:#fff; padding:15px; border-radius:12px; box-shadow:0 8px 30px rgba(0,0,0,0.2); z-index:999999; align-items:center; font-family:sans-serif; border:1px solid #eee;">
                ...
                <div style="flex-grow:1;">
                    ...
                    <div style="font-size:12px; color:#666;">हाम्रो एप इन्स्टल गर्नुहोस्</div>
                </div>
