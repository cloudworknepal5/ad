/**
 * dainiknepalnews - Universal PWA Manager (v2.1)
...
const PWA_MANAGER = {
    deferredPrompt: null,
    settings: {
        name: "dainiknepalnews",
        shortName: "dainiknepalnews",
        themeColor: "#2196f3",
        icon: "https://dainiknepalnews.com/wp-content/uploads/2026/05/logo.png"
    },
